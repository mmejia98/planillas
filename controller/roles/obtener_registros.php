<?php
    ...
    $query = "";
    $salida = array();
    $query = "SELECT id_rol, nombre, if(estado='A', 'Activo', 'Inactivo') estado FROM roles ";
    ...
    foreach($resultado as $fila){
        ...
        $sub_array[] = '<button type="button" name="editar" id="'.$fila["id_rol"].'" class="btn btn-primary btn-xs editar">Editar</button>';
