<?php
    ...
    $query = "";
    $salida = array();
    $query = "SELECT id_depto, nombre, if(estado='A', 'Activo', 'Inactivo') estado FROM departamentos ";
    ...
    foreach($resultado as $fila){
        ...
        $sub_array[] = '<button type="button" name="editar" id="'.$fila["id_depto"].'" class="btn btn-primary btn-xs editar">Editar</button>';
